...
class Reacher(Task):
    ...
    def __init__(self, target_positions, task_index, include_target_in_state=False, device='cpu'):
    ...
    def encode(self, state):
        ...
        return torch.tensor(state_np, dtype=torch.float32, device=self.device).unsqueeze(0)
    ...
    def features(self, state, action, next_state):
        ...
        return torch.tensor(phi, dtype=torch.float32, device=self.device)
